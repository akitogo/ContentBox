    ...
    discriminatorColumn="contentType"
{
    ...
    property name="categoryService" inject="provider:categoryService@contentbox" persistent="false";

    property name="contentService" inject="provider:contentService@contentbox" persistent="false";

    property name="contentVersionService" inject="provider:contentVersionService@contentbox" persistent="false";

    property name="contentTemplateService" inject="provider:ContentTemplateService@contentbox" persistent="false";

    property name="commentService" inject="provider:commentService@contentbox" persistent="false";

    property name="customFieldService" inject="provider:customFieldService@contentbox" persistent="false";

    property name="i18n" inject="provider:i18n@cbi18n" persistent="false";

    property name="JSONPrettyPrint" inject="provider:JSONPrettyPrint@JSONPrettyPrint" persistent="false";

    property name="settingService" inject="provider:settingService@contentbox" persistent="false";

    property name="mediaService" inject="provider:MediaService@contentbox" persistent="false";

    property name="statsService" inject="provider:statsService@contentbox" persistent="false";
                ...
                return arguments.target
                    ...
                    .isSlugUnique(
                        ...
                        siteID = arguments.target.hasSite()
                         ? arguments.target.getSite().getSiteID()
                         : ''
                    );
            }
        },
    ...
    BaseContent function addNewContentVersion(
        ...
        lock name="contentbox.addNewContentVersion.#getSlug()#" type="exclusive" timeout="10" throwOnTimeout="#true#" {
            ...
            if (hasActiveContent()) {
                ...
                getContentVersions()
                    .filter((version) => !isSimpleValue(version) && version.getIsActive())
            ...
            variables.customFields = arguments.original
                ...
                .map(function(thisField) {
                    return variables.customFieldService
                        .new({key: arguments.thisField.getKey(), value: arguments.thisField.getValue()})
        ...
        if (!isNull(template)) {
            ...
            for (var key in definition) {
                ...
                if (isNull(currentValue) || isNumeric(currentVal) || isBoolean(currentVal)) {
                    invoke(this, 'populate', {'memento': {'#key#': definition[key].value}});
