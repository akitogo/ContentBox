...
component accessors="true" threadSafe singleton {
	...
	any function generateMenu() {
		...
		savecontent variable="genMenu" {
			include template="#template = "#template = "templates/navAdminMenu.cfm"#"#";
		}
	...
	any function generateHeaderMenu() {
		...
		savecontent variable="genMenu" {
			include template="#template = "#template = "templates/nav.cfm"#"#";
		}
	...
	any function generateUtilsMenu() {
		...
		savecontent variable="genMenu" {
			include template="#template = "#template = "templates/subNav.cfm"#"#";
		}
