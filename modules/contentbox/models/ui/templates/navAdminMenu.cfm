...
class="
			...
			<cfif len( local.topMenu.target )>
				target="#local.topMenu.target#"
			</cfif>
			<cfif structKeyExists( local.topMenu, "data" ) && structCount( local.topMenu.data )>
...
class="
						...
						<cfif len( local.thisSubMenu.target )>
							target="#local.thisSubMenu.target#"
						</cfif>
						<cfif structKeyExists( local.thisSubMenu, "data" ) && structCount( local.thisSubMenu.data )>
