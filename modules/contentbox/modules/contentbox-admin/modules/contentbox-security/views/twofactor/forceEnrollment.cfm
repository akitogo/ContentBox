...
<div class="panel-body">#cbMessageBox().renderit()##html.startForm(
			...
			value = rc.relocationURL )##html.hiddenField( name = "rememberMe", value = rc.rememberMe )#
<fieldset><!--- Global Force ---> <div class="alert alert-warning">
...
<div class="panel panel-default">
    <div class="panel-body">#prc.twoFactorProvider.getAuthorSetupForm( prc.oAuthor )#</div>
</div>
	</cfif>
	<cfif len( prc.twoFactorProvider.getAuthorOptions() )>
		<div class="form-group">
<label>Provider Options: </label><br>#prc.twoFactorProvider.getAuthorOptions()#</div>
	</cfif>
