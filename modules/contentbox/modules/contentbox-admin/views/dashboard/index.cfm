...
<div class="col-md-12">
    <h1 class="h1">
    	<i class="fa fa-tv"></i> #prc.cbSettings.cb_dashboard_welcome_title#</h1>
    </div>
</div>

<div class="row">
    <div class="col-md-8"><!--- Dashboard welcome body ---> <p class="lead">#prc.welcomeBody#</p>
#cbMessageBox().renderit()##announce( "cbadmin_preDashboardContent" )#
...
<i class="fa fa-exclamation-triangle fa-2x"></i>#$r( "dashboard.index.installer.notice@admin" )#<button
	class="btn btn-danger btn-sm"
	onclick="deleteInstaller()"
>#$r( "dashboard.index.installer.delete@admin" )#</button>
</div>
	</cfif>
...
<a href="##latestComments" data-toggle="tab" class="nav-link">
  ...
  <div class="panel-heading">
<h3 class="panel-title">
	<i class="fa fa-users fa-lg"></i> #$r( "dashboard.index.latestLogins@admin" )#</h3>
    </div>
    <div class="panel-body">
		<div id="latestLogins">
