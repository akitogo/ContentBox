	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">
				...
				#$r( "dashboard.latestSnapshot.title@admin" )#
			</h3>
		</div>
		...
		<div class="panel-body panel-group accordion" id="accordion">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<a
						class="accordion-toggle block"
						data-toggle="collapse"
						data-parent="##accordion"
						href="##topcontent"
					>
						<i class="fa fa-chart-pie fa-lg"></i>
						#$r( "dashboard.latestSnapshot.topHitsAndComments.head@admin" )#
					</a>
				</div>
						...
						<table class="table table-hover table-striped" width="100%">
							...
							<tbody>
								<cfloop array="#prc.topContent#" index="topContent">
									<tr>
										<td>
											<a href="#prc.CBHelper.linkContent( topContent.content )#">#topContent.content.getTitle()#</a>
										</td>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					>
						...
						#$r( "dashboard.latestSnapshot.discussionCounts@admin" )#
					</a>
				</div>
				<div id="discussion" class="panel-collapse collapse">
					<div class="panel-body">
						<ul>
							<li>
								<a title="View Comments" href="#event.buildLink( prc.xehComments )#">
									#prc.commentsCount# Comments
								</a>
							</li>
							<li>
								<a title="View Approved Comments" href="#event.buildLink( prc.xehComments )#?fStatus=true">
									#prc.commentsApprovedCount# Approved
								</a>
							</li>
							<li>
								<a title="View UnApproved Comments" href="#event.buildLink( prc.xehComments )#?fStatus=false">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					>
						...
						#$r( "dashboard.latestSnapshot.contentCounts@admin" )#
					</a>
				</div>
				<div id="content" class="panel-collapse collapse">
					<div class="panel-body">
						<ul>
							<li>
								<a title="View Entries" href="#event.buildLink( prc.xehEntries )#">
									#prc.entriesCount# Entries
								</a>
							</li>
							<li>
								<a title="View Pages" href="#event.buildLink( prc.xehPages )#">
									#prc.pagesCount# Page(s)
								</a>
							</li>
							<li>
								<a title="View Categories" href="#event.buildLink( prc.xehCategories )#">
