<cfoutput>
	<!--- Entries Count --->  <input type="hidden" name="menusCount" id="menusCount" value="#prc.menuCount#"><!--- menus --->  <table name="menu" id="menu" class="table table-striped-removed table-hover " width="100%" cellspacing="0">
    <thead>
        <tr>
            <th id="checkboxHolder" class="{sorter:false}" width="20">
	<input name="checkAll" type="checkbox" onclick="window.checkAll(this.checked,'menuID')"/>
</th>
            <th>Name</th>
            <th>Slug</th>
	...
	<cfloop array="#prc.menus#" index="menu">
		<tr id="contentID-#menu.getMenuID()#" data-contentID="#menu.getMenuID()#"><!--- check box --->  <td class="text-center">
