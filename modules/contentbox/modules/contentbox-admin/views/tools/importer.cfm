	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="well well-sm text-center alert-success rounded" style="min-height: 200px">
				...
				<br /><br />
				<label class="btn btn-success btn-toggle radio" for="import-contentbox">#html.radioButton(
			name    = "importtype",
...
<div class="col-md-6">
	<div class="well well-sm text-center rounded" style="min-height: 200px">
		...
		<br />
		<label class="btn btn-toggle radio" for="import-database">#html.radioButton(
			name  = "importtype",
			id    = "import-database",
			value = "database"
...
<fieldset>
	...
	<div class="row-fluid">
		<div class="form-group">
			<div class="controls">#html.label(
			field   = "CBUpload",
			content = "Select ContentBox Package",
			class   = "control-label"
		)##getInstance( "BootstrapFileUpload@cbadmin" ).renderIt( name = "CBUpload", required = true )#</div>
			</div>
		</div>
	</fieldset>
...
default password for all authors and then do password change requests.</small><br/>#html.textField( name = "defaultPassword",
		...
		)#</div>  <div class="loaders" id="uploadBarLoader">
