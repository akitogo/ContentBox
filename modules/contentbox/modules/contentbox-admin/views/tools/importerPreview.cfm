<cfoutput>
    ...
    <h3><i class="fa fa-clone"></i> Import Preview</h3>
</div>
	<cfif !structKeyExists( prc, "contents" )>
		<div class="modal-body" id="modal-body">#cbMessageBox().renderit()#</div>
	<cfelse>
