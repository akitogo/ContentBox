...
<div class="row">
	<div class="col-md-12">#cbMessageBox().renderit()#</div>
</div>
...
<!--- Mr Picky Controls ---> <fieldset style="display:none;" id="selective_controls" class="well">
<div class="row">
	<div class="col-md-3">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_pages" class="checkbox">#html.checkbox( name = "export_pages", checked = true )# All Pages (with comments)
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_entries" class="checkbox">#html.checkbox( name = "export_entries", checked = true )# All Entries (with comments)
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_categories" class="checkbox">#html.checkbox( name = "export_categories", checked = true )# All Categories
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_contentstore" class="checkbox">#html.checkbox( name = "export_contentstore", checked = true )# All Content Store
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_menus" class="checkbox">#html.checkbox( name = "export_menus", checked = true )# All Menus
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_authors" class="checkbox">#html.checkbox( name = "export_authors", checked = true )# All Authors
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_permissions" class="checkbox">#html.checkbox( name = "export_permissions", checked = true )# All Permissions
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_roles" class="checkbox">#html.checkbox( name = "export_roles", checked = true )# All Roles
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_securityrules" class="checkbox">#html.checkbox( name = "export_securityrules", checked = true )# All Security Rules
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_settings" class="checkbox">#html.checkbox( name = "export_settings", checked = true )# All Settings
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_medialibrary" class="checkbox">#html.checkbox( name = "export_medialibrary", checked = true )# All Media Library
			</label>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-9">
		<div class="controls checkbox-spacer">
			<label for="export_emailtemplates" class="checkbox">#html.checkbox( name = "export_emailtemplates", checked = true )# All Email Templates
			</label>
		</div>
	</div>
</div>
