...
<small>Optional mail server to use or it defaults to the settings in the ColdFusion Administrator</small><br/>#html.textField(
...
<small>Optional mail server username or it defaults to the settings in the ColdFusion Administrator</small><br/>#html.textField(
...
<small>Optional mail server password to use or it defaults to the settings in the ColdFusion Administrator</small><br/>#html.passwordField(
...
defaults to port 25.</small><br/>#html.inputfield(
			type  = "numeric",
...
<small>Whether to use TLS when sending mail or not.</small><br /><br />#html.checkbox(
...
<small>Whether to use SSL when sending mail or not.</small><br /><br />#html.checkbox(
