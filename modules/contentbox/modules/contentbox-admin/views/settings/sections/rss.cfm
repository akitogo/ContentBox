...
<!--- RSS title ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "",
			content = "Feed Title: "
		)#<div class="controls">
...
<!--- RSS feed generator ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "",
...
<!--- RSS feed copyright ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "",
...
<!--- RSS feed description ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "",
...
<!--- RSS feed webmaster ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "",
...
<!--- Max RSS Entries ---> <div class="form-group">
...
<!--- Max RSS Comments ---> <div class="form-group">
...
<!--- RSS Caching ---> <div class="form-group">#html.label(
			class   = "control-label",
...
<!--- Rss Cache Timeouts ---> <div class="form-group">
...
<!--- Rss Cache Last Access Timeouts ---> <div class="form-group">
