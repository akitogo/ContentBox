...
<!--- Content Max Versions ---> <div class="form-group">
...
<!--- Commit Mandatory ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "cb_versions_commit_mandatory",
			content = "Mandatory commit changelog:"
		)#<div class="controls">
<small>When enabled a commit changelog will have to be entered before any content revision is saved.</small><br /><br />#html.checkbox(
...
<small>Enable/Disabled page excerpt summaries.</small><br /><br />#html.checkbox(
...
<small>Enable/Disabled the ability to export pages/blog/etc from the UI via format extensions like doc,print,json, and xml.</small><br /><br />#html.checkbox(
...
<!--- Hit Count ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "cb_content_hit_count",
			content = "Content Hit Count Tracking:"
		)#<div class="controls">
<small>Enable/Disable content hit count tracking</small><br /><br />#html.checkbox(
...
<!--- Hit Count Ignore bots ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "cb_content_hit_ignore_bots",
			content = "Ignore Bots Regex Matching:"
		)#<div class="controls">
<small>If enabled, the bot regex matching is ignored and hit tracking for bots is allowed </small><br /><br />#html.checkbox(
...
<!--- Bot Regex Matching ---> <div class="form-group">#html.label(
			field   = "cb_content_bot_regex",
			content = "Bot Regex Matchers:"
		)#<div class="controls">
<small>A carriage return list of regular expressions to match against browser user agents. If it matches a bot, the hit count is ignored</small>#html.textarea(
...
<!--- Content Caching ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "cb_content_caching",
			content = "Activate Page rendered content caching:"
		)#<div class="controls">
<small>Page content will be cached once it has been translated and rendered</small><br /><br />#html.checkbox(
...
<small>Blog entry content will be cached once it has been translated and rendered</small><br /><br />#html.checkbox(
...
<small>ContentStore content will be cached once it has been translated and rendered</small><br /><br />#html.checkbox(
...
<!--- Content 203 Header ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "cb_content_cachingHeader",
			content = "Send 203 Caching Header:"
		)#<div class="controls">
<small>ContentBox will emit a 203 cache header to indicate that a page is resolved with caching.</small><br /><br />#html.checkbox(
...
<!--- Content Cache Name ---> <div class="form-group">
...
<!--- Content Cache Timeouts ---> <div class="form-group">
...
<!--- Content Last Access Timeouts ---> <div class="form-group">
