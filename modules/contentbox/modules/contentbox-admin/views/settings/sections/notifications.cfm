...
<small>The email(s) that receives all notifications from ContentBox.  To specify multiple addresses, separate the addresses with commas.</small><br/>#html.inputField(
			name     = "cb_site_email",
...
<small>The email address that sends all emails out of ContentBox.</small><br/>#html.inputField(
