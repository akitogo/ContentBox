...
<!--- Min Password Length ---> <div class="form-group">
...
<!--- Password Reset Token Expiration ---> <div class="form-group">
...
<!--- Login Blocker ---> <div class="form-group">#html.label(
			class   = "control-label",
...
<!--- Max Attempts ---> <div class="form-group">
...
<!--- Block Time ---> <div class="form-group">
...
<!--- Max Auth Logs ---> <div class="form-group">
...
<!--- Rate Limiter logging ---> <div class="form-group">#html.label(
			class   = "control-label",
...
<!--- Bot Limiter ---> <div class="form-group">#html.label(
			class   = "control-label",
...
<!--- Limiter Count ---> <div class="form-group">
...
<!--- Limiter Duration ---> <div class="form-group">
...
<!--- Limiter Message ---> <div class="form-group">#html.label(
