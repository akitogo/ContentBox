...
<!--- Location ---> <div class="form-group">#html.label(
			class   = "control-label",
			field   = "",
			content = "Directory Root: "
		)#<div class="controls">
<small>The relative path or ColdFusion mapping in your server that will be the expanded root of your media manager.</small></br>#html.textField(
...
<label class="control-label" class="radio inline">#html.radioButton(
...
</label><br/>#thisProvider.description# <br/>
</div>
	</cfloop>
