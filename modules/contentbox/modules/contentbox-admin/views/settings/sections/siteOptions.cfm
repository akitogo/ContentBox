...
<legend><i class="fa fa-globe fa-lg"></i> All Site Options</legend><!--- Caching of Settings --->    <div class="form-group">
...
</div><!--- Blog EntryPoint --->    <div class="form-group">#html.label(
			class   = "control-label",
...
</fieldset><!--- Site Maintenance --->    <fieldset>
