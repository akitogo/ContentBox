...
<!--- Vertical Nav ---> <div class="tabs tabs-left"><!--- Tabs ---> <ul class="nav nav-tabs">
...
<!--- ********************************************************************* ---> 
<div class="tab-pane" id="rss_options">#view( view = "settings/sections/rss", prePostExempt = true )#</div>
#announce( "cbadmin_onSettingsContent" )#</div><!--- End Tab Content ---> </div><!--- End Vertical Nav ---> </div>
            </div>
    </div>
</div>
</cfoutput>
