...
<!--- Vertical Nav ---> <div class="tabs tabs-left"><!--- Documentation Navigation Bar ---> <ul class="nav nav-tabs">
...
</li>#announce( "cbadmin_onCommentSettingsNav" )#</ul>
<!--- Tab Content ---> <div class="tab-content">
<!--- comment options ---> <div class="tab-pane active" id="general_options">
...
<!--- Enable Moderation ---> <div class="form-group">#html.label(
...
<!--- Comment Previous History ---> <div class="form-group">#html.label(
...
<p>
	If an approved comment is found for the submitting email address, the comment is automatically approved and not moderated.
			...
			data    = {
				toggle : "toggle",
				match  : "cb_comments_moderation_whitelist"
			},
...
<!--- Moderated Keywords ---> <div class="form-group">#html.label(
...
<!--- Blocked Keywords ---> <div class="form-group">#html.label(
...
<!--- Auto-Delete Moderated Comments ---> <div class="form-group">#html.label(
			field   = "cb_comments_moderation_expiration",
			content = "Number of days before auto-deleting moderated comments:"
		)#<div class="controls">
<p>If a comment has been moderated, it will be auto-deleted after the specified number of days (set to 0 to disable auto-deletion).</p><br/>#html.inputField(
...
<!--- Notifications ---> <div class="tab-pane" id="notifications">
                       <fieldset>
...
<!--- Email Notifications ---> <div class="form-group">#html.label(
...
<!--- Notification on Comment ---> <div class="form-group">#html.label(
			field   = "cb_comments_notify",
...
<!--- Notification on Moderation ---> <div class="form-group">#html.label(
