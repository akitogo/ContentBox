...
>#getInstance( "Avatar@contentbox" ).renderAvatar(
	...
	title="Created Date"
>
	<i class="fa fa-calendar mr5"></i> #args.content.getDisplayCreatedDate()#</div>

	<cfif args.content.hasCategories()>
		<div class="mt10 mb5">
<div class="text-muted">
	<span title="Categories">
		<i class="fa fa-tags"></i> #args.content.getCategoriesList()#</span>
	</div>
</div>
	</cfif>
	<!--- Slug --->       
...
<div class="text-muted">
	<i class="fa fa-info-circle mr5"></i> #args.content.getDescription()#</div>
</div>
	</cfif>
