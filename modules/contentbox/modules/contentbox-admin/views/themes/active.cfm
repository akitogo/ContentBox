...
<div class="pull-right mt10">
   	<button class="btn btn-primary"
   			onclick="popup( '#event.buildLink( prc.xehPreview )#/l/#encodeForJavaScript( prc.activeTheme.name )#/h/#hash( prc.oCurrentAuthor.getAuthorID() )#');return false;">#cbAdminComponent( "ui/Icon",
		{ name : "Eye" } )# 
			Preview
	</button>
</div>
...
<h1 class="h1">
	<i class="fa fa-swatchbook fa-lg"></i> #encodeForHTML( prc.activeTheme.themeName )#</h1>
    </div>
</div>
...
#cbMessageBox().renderit()#<!--- screenshot ---> <div id="theme-screenshot" class="pull-right">
...
<br/>
	...
	<cfif prc
		...
		.settings
		.len()>
		<h1>Theme Settings:</h1>#html.startForm( action = prc.xehSaveSettings,
...
<div class="form-group text-center">#html.submitButton( value = "Save Settings", class = "btn btn-primary btn-lg" )#</div>
#html.endForm()#
	</cfif>
