	...
	<div class="modal-dialog" role="document" >
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="importTitle"><i class="fa fa-clone"></i> #args.title#</h4>
</div>#html.startForm(
		name      = "importForm",
		action    = "#args.action#",
		class     = "form-vertical",
...
<div class="modal-body">
		<p>#args.contentInfo#</p>#getInstance( "BootstrapFileUpload@cbadmin" ).renderIt(
		name     = "importFile",
		required = true,
		accept   = "application/json"
	)#<label for="overrideContent">Override content?</label>
<small>By default all content that exist are NOT overwritten.</small><br>#html.select(
		options       = "true,false",
