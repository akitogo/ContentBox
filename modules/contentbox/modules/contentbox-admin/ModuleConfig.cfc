	...
	function configure() {
		...
		interceptorSettings = {
			...
			customInterceptionPoints : [
				...
				"cbadmin_onTopBar",
				// Editor Events
				"cbadmin_contentEditorSidebar",
				"cbadmin_contentEditorSidebarAccordion",
				"cbadmin_contentEditorSidebarFooter",
				"cbadmin_contentEditorFooter",
				"cbadmin_contentEditorInBody",
				"cbadmin_contentEditorNav",
				"cbadmin_contentEditorNavContent",
				// Entry Events
