<cfoutput>
	#html.doctype()#<!--[if lt IE 7]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7"> <![endif]-->
...
<!--<![endif]-->
	...
	<body class="animated fadeIn">#announce( "cbadmin_afterLoginBodyStart" )#<section id="container">
      <header id="header">
      	<!--logo start-->
          <div class="brand">
              <a class="logo">
...
<!--- Login Container ---> <section id="login-container">#announce( "cbadmin_beforeLoginContent" )##view()##announce( "cbadmin_afterLoginContent" )#</section>
